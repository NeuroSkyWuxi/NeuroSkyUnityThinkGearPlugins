...
struct  X509RevocationFlag_t326021344 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(X509RevocationFlag_t326021344, ___value___1)); }
