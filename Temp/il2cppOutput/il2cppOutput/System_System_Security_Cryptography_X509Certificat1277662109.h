...
struct  X509SubjectKeyIdentifierHashAlgorithm_t1277662109 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(X509SubjectKeyIdentifierHashAlgorithm_t1277662109, ___value___1)); }
