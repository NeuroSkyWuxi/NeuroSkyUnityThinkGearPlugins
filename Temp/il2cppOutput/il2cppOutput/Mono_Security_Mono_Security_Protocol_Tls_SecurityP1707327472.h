...
struct  SecurityProtocolType_t1707327472 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SecurityProtocolType_t1707327472, ___value___1)); }
