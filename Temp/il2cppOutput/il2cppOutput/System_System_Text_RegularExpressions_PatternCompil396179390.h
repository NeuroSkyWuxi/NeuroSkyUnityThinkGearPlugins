...
public:
	inline static int32_t get_offset_of_base_addr_0() { return static_cast<int32_t>(offsetof(Link_t396179390, ___base_addr_0)); }
	...
	inline static int32_t get_offset_of_offset_addr_1() { return static_cast<int32_t>(offsetof(Link_t396179390, ___offset_addr_1)); }
...
struct Link_t396179390_marshaled_pinvoke
{
	int32_t ___base_addr_0;
	int32_t ___offset_addr_1;
};
// Native definition for marshalling of: System.Text.RegularExpressions.PatternCompiler/PatternLinkStack/Link
struct Link_t396179390_marshaled_com
{
	int32_t ___base_addr_0;
	int32_t ___offset_addr_1;
};
