...
struct  NetscapeCertTypeExtension_t3510265670  : public X509Extension_t4211806920
{
public:
...
public:
	inline static int32_t get_offset_of_ctbits_3() { return static_cast<int32_t>(offsetof(NetscapeCertTypeExtension_t3510265670, ___ctbits_3)); }
