...
struct  ExchangeAlgorithmType_t3271961912 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ExchangeAlgorithmType_t3271961912, ___value___1)); }
