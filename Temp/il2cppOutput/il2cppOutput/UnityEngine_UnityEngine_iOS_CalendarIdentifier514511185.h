...
struct  CalendarIdentifier_t514511185 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(CalendarIdentifier_t514511185, ___value___1)); }
