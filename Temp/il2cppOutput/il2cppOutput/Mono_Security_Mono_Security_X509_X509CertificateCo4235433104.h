...
struct  X509CertificateEnumerator_t4235433105  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_enumerator_0() { return static_cast<int32_t>(offsetof(X509CertificateEnumerator_t4235433105, ___enumerator_0)); }
