...
struct  UnityWebRequestError_t947498394 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(UnityWebRequestError_t947498394, ___value___1)); }
